                  ...
                  <div class="card card--universal card--clickable">
                     ...
                     <div class="card__content">
                        <div class="card__body">
                           <p class="meta-info"><span class="meta-info__item">{{ dataset.getPublisher?.name }}</span><span class="meta-info__item">{{ dataset.getModified ? dataset.getModified  : '' }}</span></p>
                           <div class="card__title">
                              <h3>{{ dataset.getTitle }}</h3>
                           </div>
                           <p>{{ dataset.getDescription }}</p>

                           <p class="meta-info"><span class="meta-info__item">Specifications related to content type (Author, PDF specs etc)</span></p>
